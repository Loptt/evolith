...
public class MutationManager implements Commons{
    ...
    public MutationManager(Organism org, Game game) {
        ...
        m1.add(new Mutation("Sting",40,-20,0,20,false,2,org.getX(),org.getY(),org.getWidth(),102*org.getWidth()/77, game, org));
        m1.add(new Mutation("Claws",60,-20,0,0,false,3,org.getX(),org.getY(),org.getWidth(),108*org.getWidth()/265, game, org));
        m1.add(new Mutation("Horns",80,-20,0,-40,false,4,org.getX(),org.getY(),org.getWidth(),79*org.getWidth()/248, game, org));
        mutations.add(m1);
        ...
        m2.add(new Mutation("4 legs",0,40,0,0,false,2,org.getX(),org.getY() + org.getHeight()/2 ,org.getWidth(), 146*org.getWidth()/380, game, org));
        m2.add(new Mutation("6 legs",0,60,-20,0,false,3,org.getX(),org.getY() + org.getHeight()/2,org.getWidth(), 146*org.getWidth()/392,game, org));
        m2.add(new Mutation("Wings",-20,80,-40,20,false,4,org.getX(),org.getY(),org.getWidth(), 182*org.getWidth()/473,game, org));
        mutations.add(m2);
